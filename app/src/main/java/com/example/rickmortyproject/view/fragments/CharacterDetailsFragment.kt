...
import com.example.rickmortyproject.utils.EpisodeDiffUtilCallback
import com.example.rickmortyproject.utils.LocationDiffUtilCallback
...
class CharacterDetailsFragment : Fragment(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val characterDetailsComponent = (requireActivity().applicationContext as App).appComponent.getCharacterDetailsComponentBuilder()
